             ...
             <div className='icontype'><i className="fa fa-shopping-basket"></i></div>
                ...
                <div className="author_list_pp">
                    <span onClick={()=> navigateTo(`${nft.author_link}/${nft.author.id}`)}>                                    
                        <img className="lazy" src={api.baseUrl + (nft.author.avatar.url ? nft.author.avatar.url : '')} alt=""/>
                ...
                <Outer>
                    <span>
                        <img onLoad={onImgLoad} src={api.baseUrl + (nft.preview_image.url ? nft.preview_image.url: '')} className="lazy nft__item_preview" alt=""/>
                    </span>
                </Outer>
                </div>
                { nft.deadline && !clockTop &&
