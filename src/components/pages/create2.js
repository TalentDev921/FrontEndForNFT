...
constructor(props) {
  ...
  handleValidation() {
    ...
    if (method === 'on_auction' && !fields["price_over"]) {
      formIsValid = false;
      errors["price_over"] = "Cannot be empty";
    }
...
render() {
    ...
    let message = '';
    if (!isAuthorized) {
      message = `You can't create NFT.<br/>Please sign in this site.`;
    }
          ...
          <div className="col-lg-7 offset-lg-1 mb-5">
              <form id="form-create-item" className="form-border" onSubmit={this.handleSubmit}>
                  ...
                  <div className="field-set">
                                          ...
                                          <div id="tab_opt_1">
                                                ...
                                                <div className="row">
                                                  <div className="col-md-8">
                                                    <input type="number" name="item_price" id="item_price" onChange={this.handleChange} className="form-control mb-2" placeholder="enter price for one item" />
                                            ...
                                            <div id="tab_opt_2" className='hide'>
                                                ...
                                                <div className="row">
                                                  <div className="col-md-8">
                                                    <input type="number" name="price_over" id="price_over" onChange={this.handleChange} className="form-control mb-2" placeholder="enter minimum bid" />
                                                    <span style={{ color: "red" }}>{this.state.errors["price_over"]}</span>
                                                  </div>
                                                  <div className="col-md-4">
                                                    <RadioGroup row aria-label="token_type" defaultValue={'BNB'}  name="row-radio-buttons-group" style={{float: 'right'}} value={this.state.token_type} onChange={this.handleTokenType}>
                                                      <FormControlLabel value="BNB" control={<Radio />} label="BNB" />
                      ...
                      <h5>Royalties</h5>
                      <input type="number" name="item_royalties" id="item_royalties" onChange={this.handleChange} className="form-control mb-2" placeholder="suggested: 0, 10%, 20%, 30%. Maximum is 70%" />
          ...
          <div className="col-lg-3 col-sm-6 col-xs-12">
                  ...
                  <div className="nft__item m-0">
                      ...
                      <div className="nft__item_info">
                          ...
                          {this.state.method === 'on_auction' && this.state.fields.price_over && (
                            <div className="nft__item_price">
                              {this.state.fields.price_over} {this.state.token_type}
                            </div>
                          )}
                      </div> 
                  </div>
