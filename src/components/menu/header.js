...
const Header= function() {
  ...
  const onSignOutHandler = () => {
    ...
    NotificationManager.success("Sign out succeed.", "Success");
    //move to home page 
    navigate('/home');
  }
            ...
            <input id="quick_search" className="xs-hide" name="quick_search" placeholder="search item here..." type="text" />
              ...
              <BreakpointProvider>
                <Breakpoint l down>
                  {showmenu && 
                  <div className='menu'>
                    <div className='navbar-item' ref={ref} onClick={handleBtnClick}>
          ...
          <div className='mainside'>
            ...
            <div className="logout">
              ...
              <div id="de-click-menu-profile" className="de-menu-profile" onClick={() => btn_icon_pop(!showpop)} ref={refpop}>
                { currentUsr && currentUsr.avatar && isAuthorized &&  (
                  <img src={`${api.baseUrl}${api.media}/${currentUsr.avatar.hash}${currentUsr.avatar.ext}`} alt="" />
                )}
                {currentUsr && isAuthorized &&  showpop &&
                  <div className="popshow">
                    ...
                    <ul className="de-submenu-profile">
                      <li>
                          <NavLink to="/my_profile"><i className="fa fa-user"></i> My profile</NavLink>
                      </li>
                      <li>
                          <NavLink to="/edit_profile"><i className="fa fa-pencil"></i> Edit profile</NavLink>
                      </li>
